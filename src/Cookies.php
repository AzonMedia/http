...
use Azonmedia\Http\Interfaces\CookiesInterface;
...
class Cookies implements CookiesInterface
{
     ...
     *
     * $Cookies = new Cookies([]);
     * $Cookies->set('test', ['value' => 'test 1', 'domain' => 'testdomain.com', 'path' => ...]);
     * $header_cookies = $Cookies->toHeaders();
     *
     ...
     * required: $name & $properties['value']
     * optional: $properties['domain'], $properties['path'], $properties['expires'], $properties['secure'], $properties['hostonly'], $properties['httponly'], $properties['samesite']
     *
     * @return string
     */
